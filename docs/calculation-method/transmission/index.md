...
$U$ — коефіцієнт теплопередачі підлоги на ґрунті, Вт/(м²·К), який визначають за формулою (9) якщо $d_t<B'$ (неізольована або посередньо ізольована підлога) або за формулою (10) якщо $d_t≥B'$ (добре ізольована підлога).

$$U=\frac{2λ}{\pi B'+d_t}\ln\left(\frac{\pi B'}{d_t}+1\right)\tag{9},$$

$$U=\frac{λ}{0,475 B'+d_t}\tag{10},$$

де $B'$ — характерний розмір підлоги, що дорівнює відношенню площі підлоги на половину периметра за формулою:
...
$λ$ — теплопровідність ґрунту, приймають згідно з [таблицею 4.1.1](index.md#411-теплопровідність-ґрунту);
$R_{si}$ — тепловій опір внутрішнього середовища, приймають згідно з [таблицею 4.1.2](index.md#412-тепловий-опір-навколишнього-середовища);
$R_f$ — термічний опір підлоги, включаючи всі шари, м²·К/Вт розрахований за формулою (7);
$R_{se}$ — тепловий опір зовнішнього середовища, приймать згідно з [таблицею 4.1.2](index.md#412-тепловий-опір-навколишнього-середовища).
...
$U_{bf}$ — коефіцієнт теплопередачі підлоги на ґрунті у підвалі (цокольному поверсі), Вт/(м²·К), визначений за формулою (14) якщо $d_t+0,5z<B'$ (неізольована та посередньо теплоізольована підлога підвалу) або за формулою (15) якщо $d_t+0,5z≥B'$ (добре теплоізольована підлога підвалу);  
$U_{bw}$ — коефіцієнт теплопередачі стін, що контактують із ґрунтом, Bт/(м²·K), визначений за формулою (16).

$$U_{bf}=\frac{2λ}{\pi B'+d_t+0,5z}\ln\left(\frac{\pi B'}{d_t+0,5z}+1\right),\tag{14}$$

$$U_{bf}=\frac{2λ}{0,457 B'+d_t+0,5z},\tag{15}$$

де $B'$ — характерний розмір підлоги, розраховують за формулою (11), м;
