...
де $U_x$ — значення коефіцієнта теплопередачі світлопрозорих конструкцій (вікон) – $U_W$, $U_{WS}$ чи дверей — $U_D$ Вт/(м²·К), що визначають згідно з [додатком б](../appendix-b.md).
...
де $h_{si}$, $h_{se}$ — коефіцієнти теплообміну внутрішньої і зовнішньої поверхонь огороджувальної конструкції, Вт/(м²·К), які приймають згідно з [додатком б](../appendix-b.md);  
$R_i$ — тепловий опір $i$-го шару конструкції, м²·К/Вт;  
$d_i$ — товщина $i$-го шару конструкції, м;  
$\lambda_{ip}$ — теплопровідність матеріалу $i$-го шару конструкції за розрахункових умов експлуатації (розрахункова теплопровідність), Вт/(м·К), приймають згідно з [додатком а](../appendix-a.md);  
