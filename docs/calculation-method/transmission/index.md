...
де $R_\sum$ — опір теплопередачі що визначають згідно з ДСТУ 9191[^3] за формулою (7), м²·К/Вт.
...
де $h_{si}$, $h_{se}$ — коефіцієнти теплообміну внутрішньої і зовнішньої поверхонь огороджувальної конструкції, Вт/(м²·К), які приймають згідно з ==додатком б==;
$R_i$ — тепловий опір $i$-го шару конструкції, м²·К/Вт;
$d_i$ — товщина $i$-го шару конструкції, м;
$\lambda_{ip}$ — теплопровідність матеріалу $i$-го шару конструкції за розрахункових умов експлуатації (розрахункова теплопровідність), Вт/(м·К), приймають згідно з ==додатком а==;
