...
Стаціонарний узагальнений коефіцієнт теплопередачі трансмісією до ґрунту $H_g$ розраховують за формулою:

$$H_g=A·U\tag{8},$$

де $A$ — площа підлоги, м²;  
$U$ — коефіцієнт теплопередачі підлоги на ґрунті, Вт/(м²·К), який визначають за формулою (9) якщо $d_t<B^{'}$ (неізольована або посередньо ізольована підлога) або за формулою (10_ якщо $d_t≥B^{'}$ (добре ізольована підлога).

$$U=\frac{2λ}{\pi B^{'}+d_t}\ln\left(\frac{\pi B^{'}}{d_t}+1\right)\tag{9},$$

$$U=\frac{λ}{0,475 B^{'}+d_t}\tag{10},$$

де — характерний розмір підлоги, що дорівнює відношенню площі підлоги на половину периметра за формулою:

$$B^{'}=\frac{A}{0,5P}\tag{11},$$

— еквівалентна товщина підлоги, яку розраховують за формулою:
