...
$$U_i=U_{op}+_\Delta U_{tb}\tag{5},$$

де $_\Delta U_{tb}$ — додаткова складова до коефіцієнта теплопередачі непрозорих конструкцій $U_{op}$, що враховує вплив теплопровідних включень, Вт/(м²·К), розрахункові значення якої наведені в [таблиці 3.2.1](transmission.md#321-значення-додаткової-складової-до-коефіцієнта-теплопередачі-які-враховують-вплив-теплопровідних-включень);  
