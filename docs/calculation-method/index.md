...
# Методика визначення енергоспоживання на опалення
...
$$
Q_{nd}=\frac{Q_{ht}-η_{gn}·Q_{gn}}{1000},
\tag{1}
%\label{eq1}
$$
...
$$
Q_{gen,ls}=Q_{dis,in}(1-\eta_{gen})/\eta_{gen}
\tag{5}
%\label{eq5}
$$
...
$$
Q_{dis,in}=Q_{dis,ls,nrvd}+Q_{em,in}
\tag{6}
%\label{eq6}
$$
