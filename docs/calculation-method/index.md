...
Для кожного місяця енергопотребу для опалення $Q_{nd}$ Вт·год, розраховують за формулою:

$$Q_{nd}=Q_{ht}-η_{gn}·Q_{gn}, \tag{1}$$

де $Q_{ht}$ — сумарна теплопередача в режимі опалення, Вт·год визначена за формулою $\eqref{eq2}$,  
$Q_{gn}$ — сумарні теплонадходження в режимі опалення, Вт·год визначені за формулою $\eqref{eq3}$,  
