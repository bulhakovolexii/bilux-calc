...
Для кожного місяця енергопотребу $Q_{nd}$ Вт·год, розраховують за формулою:

$$Q_{nd}=Q_{ht}-η_{gn}·Q_{gn}, \tag{1}$$
...
$$Q_{use}=Q_{gen,out}+Q_{gen,is},\tag{4}$$

де $Q_{gen,out}$  — енергія виходу з підсистеми виробництва/генерування та акумулювання теплоти, що розраховується за формулою ==НОМЕР==;  
$Q_{gen,is}$ — 

{: .important }
> Для розрахунку енергоспоживання, використовують тривалість опалювального періоду відповідно до ДСТУ-Н Б В.1.1-27[^4] (дані приведені у ==додатку F==) для будівель закладів освіти, закладів дошкільної освіти та закладів охорони здоровʼя з температурою менше ніж 10℃, для інших будівель — з температурою менше ніж 8℃.
