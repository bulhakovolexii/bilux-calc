...
де $U_x$ — значення коефіцієнта теплопередачі світлопрозорих конструкцій (вікон) – $U_W$, $U_WS$ чи дверей — $U_D$ Вт/(м²·К), що визначають згідно з [додатком 2](./appendix-b.md).
