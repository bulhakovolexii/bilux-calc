...
URL: https://bulhakov.dev/bilux-calc/appendixes/appendix-c/
**/
...
const materials = [
  {
    ...
    subtypes: [
      {
        id: "1-1",
        name: "Волокнисті матеріали",
        names: [
          {
            id: "1-1-1",
            name: "Вироби теплоізоляційні з мінеральної вати на основі базальтового волокна",
            variants: [
              { id: "1-1-1-1", density: "30", conductivity: "0.05" },
      ...
      {
        id: "1-3",
        name: "Вироби з природної органічної та неорганічної речовини",
        names: [
          {
            id: "1-3-10",
      ...
      {
        id: "1-5",
        name: "Матеріали теплоізоляційні засипні",
        names: [
          {
            id: "1-5-24",
  ...
  {
    id: "2",
    name: "Конструкційно-теплоізоляційні матеріали",
    subtypes: [
      {
        id: "2-7",
        name: "Бетони ніздрюваті",
      ...
      {
        id: "2-12",
        name: "Цегляна кладка з порожнистої цегли",
        names: [
          {
            id: "2-12-58",
      ...
      {
        id: "2-13",
        name: "Кладка з виробів бетонних",
        names: [
          {
            id: "2-13-61",
  ...
  {
    id: "3",
    name: "Матеріали конструкційні",
    subtypes: [
      {
        id: "3-14",
        name: "Бетони конструкційні",
        names: [
          {
            id: "3-14-64",
            name: "Залізобетон",
      ...
      {
        id: "3-16",
        name: "Облицювання природним каменем та керамічною плиткою",
        names: [
          {
            id: "3-16-69",
      ...
      {
        id: "3-17",
        name: "Кладка цегляна з повнотілої цегли",
        names: [
          {
            id: "3-17-74",
      ...
      {
        id: "3-18",
        name: "Матеріали покрівельні, гідроізоляційні, пароізоляційні та покриття полімерні для підлог",
        names: [
          {
            id: "3-18-80",
